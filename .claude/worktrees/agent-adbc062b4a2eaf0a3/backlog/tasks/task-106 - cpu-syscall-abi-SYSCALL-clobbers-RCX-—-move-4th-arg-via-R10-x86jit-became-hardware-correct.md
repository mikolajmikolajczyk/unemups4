...
- [x] #2 NativeContext::arg3() reads R10 instead of RCX (context.rs); the exec.rs:376 + doc-1 decision-2 comments corrected to reflect that SYSCALL clobbers RCX/R11 and the 4th arg travels via R10
