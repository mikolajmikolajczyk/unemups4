...
- **opcodes.rs**: `op::IT_*` u8 constants (NOP, CLEAR_STATE, INDEX_BUFFER_SIZE, DISPATCH_DIRECT/INDIRECT, INDEX_BASE, DRAW_INDEX_2, CONTEXT_CONTROL, INDEX_TYPE, DRAW_INDEX_AUTO, NUM_INSTANCES, DRAW_INDEX_OFFSET_2, WRITE_DATA, WAIT_REG_MEM, INDIRECT_BUFFER, PFP_SYNC_ME, EVENT_WRITE/_EOP/_EOS, DMA_DATA, ACQUIRE_MEM, SET_CONFIG/CONTEXT/SH/UCONFIG_REG). Values mirror shadPS4 `video_core/amdgpu/pm4_opcodes.h`. `reg_base` window consts (CONFIG 0x2000, CONTEXT 0xA000, SH 0x2C00, UCONFIG 0xC000). `name()` / `set_reg_base()` lookups.
