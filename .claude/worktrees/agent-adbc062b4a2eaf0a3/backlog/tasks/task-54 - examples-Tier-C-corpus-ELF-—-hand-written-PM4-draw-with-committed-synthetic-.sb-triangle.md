...
- [ ] #4 The Tier-C ELF is GENUINELY shadPS4-runnable — real .sb bytes + real addresses + a real vertex buffer (NO marker addresses like task-24's embedded path) — enabling the task-58 black-box cross-emulator framebuffer compare
<!-- AC:END -->
