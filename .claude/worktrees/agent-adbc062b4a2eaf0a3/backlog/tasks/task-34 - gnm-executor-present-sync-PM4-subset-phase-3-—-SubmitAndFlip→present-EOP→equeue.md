...
- [x] #3 executor reaches the backend over the display-thread channel per doc-4 §3 (no new async GPU thread); present path from task-25 reused, not duplicated
