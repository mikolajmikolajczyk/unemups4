...
//! GCN→SPIR-V recompiler (doc-4 §1, phase 4).
//!
...
pub use recompile::{
    BufferBinding, IoLayout, IoRole, IoVar, PushConstantField, PushConstantRole, RecompileError,
    RecompiledShader, SamplerBinding, ShaderStage, recompile,
};
