...
<!-- SECTION:NOTES:BEGIN -->
DONE on branch feat/task-3-cpu-wrapper (commit c915dd6, GPG-signed, pre-commit passed; NOT merged/pushed). Old native path (launch.s/trampoline.s/vmstate.rs) left compiled and functional — still the active path until task-5.
